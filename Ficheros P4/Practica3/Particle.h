...
protected:
	...
	float inverse_mass;                        // masa inversa. Si es 0 la masa sera infinita
...
public:
	...
	inline void setMass(float mass) { inverse_mass = 1 / mass; }
	inline void setMaxRecorrido(float maxRec) { maxRecorrido = maxRec; }
	inline void setActive(bool act);
	inline void increaseMass() { inverse_mass = 1 / (1 / inverse_mass + 0.1); }
	inline void decreaseMass() { if(inverse_mass > 0.1) inverse_mass = 1 / (1 / inverse_mass - 0.1); }
